        ...
        alternativas: [
            {
                ...
                afirmação: "Notou também que muitas pessoas não sabem ainda utilizar as ferramentas..."
            },
            {
                texto: "Criar uma imagem utilizando um gerador de imagem de IA."
                ,afirmação: "Acelerou o processo de criação de trabalhos utilizando geradores de imagem."
            }
        ...
        alternativas: [
            {
                ...
                afirmação: "Infelizmente passou a utilizar a IA para fazer todas suas tarefas e agora..."
            },
            {
                texto: "O chat pode ser uma tecnologia muito avançada, mas é preciso manter a atenção pois toda máquina erra, por isso revisar o trabalho e contribuir com as perspectivas pessoais é essencial."
                ,afirmação: "Percebeu que toda IA reproduz orientações baseadas na empresa que programa"
            }
